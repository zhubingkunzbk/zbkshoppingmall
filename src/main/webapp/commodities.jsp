...
<body>
    ...
    <div class="center core-div">
        <div class="commodity-show">
            <c:forEach items="${requestScope.commoditiesList}" var="commodity" varStatus="vs">
                <div><img src="${commodity.showImgSrc}" width="290px" height="290px">
                    <div><span class="price">￥${commodity.price}</span><span>76人付款</span></div>
                    <div class="title"><a href="http://localhost/commodities/getCommodityDetail?commodityId=${commodity.id}">${commodity.title}</a></div>
                    <div class="seller-info"><span class="seller-name">${commodity.userAccountNumber}</span><span class="seller-address">日本</span><div style="clear: both"></div></div>
                </div>
            </c:forEach>
...
<%--        </div>--%>
        ...
        <div class="paging">
            ...
            <button class="page-number paging-selection">1</button>
            <button class="pre-page">下一页&gt;</button>
        </div>
    </div>
    <footer>
